...
- 老包：`D:\code\otherProjects\18_comparePakage\prototype\lib_v1.jar`（版本 3.12.0）
- 新包：`D:\code\otherProjects\18_comparePakage\prototype\lib_v2.jar`（版本 3.14.0）
...
> 共 12 个修改类已反编译；另 329 个修改类未展开（受 Top-K 限制）。

### org/apache/commons/lang3/AnnotationUtils$1.class
- 反编译引擎：cfr
```diff
--- old/org/apache/commons/lang3/AnnotationUtils$1.class
+++ new/org/apache/commons/lang3/AnnotationUtils$1.class
@@ -16,7 +16,7 @@
 /*
...
- 反编译引擎：cfr
```diff
--- old/org/apache/commons/lang3/AnnotationUtils.class
+++ new/org/apache/commons/lang3/AnnotationUtils.class
@@ -2,125 +2,35 @@
...
- 反编译引擎：cfr
```diff
--- old/org/apache/commons/lang3/ArchUtils.class
+++ new/org/apache/commons/lang3/ArchUtils.class
@@ -2,60 +2,22 @@
  * Decompiled with CFR 0.152.
  * 
  * Could not load the following classes:
...
- 反编译引擎：cfr
```diff
--- old/org/apache/commons/lang3/ArrayUtils.class
+++ new/org/apache/commons/lang3/ArrayUtils.class
@@ -6,12 +6,14 @@
...
- 反编译引擎：cfr
```diff
--- old/org/apache/commons/lang3/BitField.class
+++ new/org/apache/commons/lang3/BitField.class
@@ -4,79 +4,79 @@
 package org.apache.commons.lang3;
...
- 反编译引擎：cfr
```diff
--- old/org/apache/commons/lang3/BooleanUtils.class
+++ new/org/apache/commons/lang3/BooleanUtils.class
@@ -8,11 +8,16 @@
  */
 package org.apache.commons.lang3;
...
- 反编译引擎：cfr
```diff
--- old/org/apache/commons/lang3/CharRange$CharacterIterator.class
+++ new/org/apache/commons/lang3/CharRange$CharacterIterator.class
@@ -13,7 +13,7 @@
 /*
  * Exception performing whole class analysis ignored.
  */
...
- 反编译引擎：cfr
```diff
--- old/org/apache/commons/lang3/CharRange.class
+++ new/org/apache/commons/lang3/CharRange.class
@@ -3,24 +3,39 @@
  * 
  * Could not load the following classes:
...
- 反编译引擎：cfr
```diff
--- old/org/apache/commons/lang3/CharSequenceUtils.class
+++ new/org/apache/commons/lang3/CharSequenceUtils.class
@@ -14,8 +14,26 @@
